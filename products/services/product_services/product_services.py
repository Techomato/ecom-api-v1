...
from products.models.export_models.export_category import ExportECOMCategoryList, ExportECOMCategory
...
from products.utils.interfaces.types.request_and_response_types.request_types.add_category_request_type import (
...
class ProductServices:
    ...
    def get_all_categories_subcategories_service() -> ExportECOMCategoryList:
        try:
            ...
            if all_categories:
                category_list = [ExportECOMCategory(**category.model_to_dict()) for category in all_categories]
